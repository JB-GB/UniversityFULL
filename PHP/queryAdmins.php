<?php 
    ...
    $queryAlumnos = "SELECT * FROM administradores";
                            ...
                            <?php
                                if($result->num_rows>0){
                                    ...
                                    ?>
                                        ...
                                        <td><?php echo $row['prnom_Emp']; ?></td>
                                        <td><?php echo $row['segnom_Emp']; ?></td>
                                        <td><?php echo $row['prape_Emp']; ?></td>
                                        <td><?php echo $row['segape_Emp']; ?></td>
                                        <td><?php echo $row['mail_Emp']; ?></td>
                                        <td><?php echo $row['tel_Emp']; ?></td>
                                        
                                        <td><a class="btn btn-success" href="updateAdmins.php?id=<?php echo $row['id_Emp'];?>">UPDATE</a>
                                        <a class="btn btn-danger" href="deleteAdmins.php?idAB=<?php echo $row['id_Emp'];?>">DELETE</a></td>
                                    </tr>
                                    <?php
                                    }
                                }
