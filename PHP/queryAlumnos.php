<?php 
    ...
    $queryAlumnos = "SELECT * FROM alumnado";
                            ...
                            <?php
                                if($result->num_rows>0){
                                    ...
                                    ?>
                                        ...
                                        <td><?php echo $row['prnom_Alumno']; ?></td>
                                        <td><?php echo $row['segnom_Alumno']; ?></td>
                                        <td><?php echo $row['prape_Alumno']; ?></td>
                                        <td><?php echo $row['segape_Alumno']; ?></td>
                                        <td><?php echo $row['mail_Alumno']; ?></td>
                                        <td><?php echo $row['tel_Alumno']; ?></td>
                                        
                                        <td><a class="btn btn-success" href="updateAlumnos.php?id=<?php echo $row['id_Alumno'];?>">UPDATE</a>
                                        <a class="btn btn-danger" href="deleteAlumnos.php?idAB=<?php echo $row['id_Alumno'];?>">DELETE</a></td>
                                    </tr>
                                    <?php
                                    }
                                }
